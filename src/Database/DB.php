...
class DB
{
    ...
    public static function migrate(): void
    {
        ...
        $pdo->exec('CREATE UNIQUE INDEX IF NOT EXISTS idx_refresh_tokens_token_hash ON refresh_tokens(token_hash)');
        $pdo->exec('CREATE INDEX IF NOT EXISTS idx_refresh_tokens_user_id ON refresh_tokens(user_id)');
    }
}
