...
class PermissionValidator
{
    ...
    {
        $dto = new \App\DTO\CreatePermissionDTO();
        $dto->name = $data['name'] ?? '';
        return $this->validate($dto);
    }

    public function validateUpdate(array $data, int $permissionId): array
    {
        $dto = new \App\DTO\UpdatePermissionDTO();
        $dto->name = $data['name'] ?? '';
        return $this->validate($dto, $permissionId);
    }
}
